...
class Post(models.Model):
    ...
    cover_representation = models.ImageField(upload_to='blog_cover_images/', default='default.jpg')
    wallpaper_representation = models.ImageField(upload_to='blog_wallpaper_images/', default='default.jpg')
